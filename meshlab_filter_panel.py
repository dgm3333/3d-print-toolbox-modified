...
# This code basically comes from the following locations
...
class VIEW3D_OT_print3d_actions(Operator):
    """Move items up and down, add and remove"""
    bl_idname = "VIEW3D.print3d_actions"
...
class VIEW3D_OT_print3d_printItems(Operator):
    """Print all items and their properties to the console"""
    bl_idname = "VIEW3D.print3d_printItems"
...
class VIEW3D_OT_print3d_clearList(Operator):
    """Clear all items of the list"""
    bl_idname = "VIEW3D.print3d_clearList"
    bl_label = "Clear List"
...
class VIEW3D_OT_print3d_removeDuplicates(Operator):
    """Remove all duplicates"""
    bl_idname = "VIEW3D.print3d_removeDuplicates"
...
class VIEW3D_OT_print3d_selectItems(Operator):
    """Select Items in the Viewport"""
    bl_idname = "VIEW3D.print3d_selectItems"
...
class VIEW3D_UL_print3d_items(UIList):
...
class VIEW3D_PT_print3d_objectList(Panel):
    """Adds a custom panel to the TEXT_EDITOR"""
    bl_idname = 'VIEW3D.print3d_objectList'
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_label = "MeshLab Filters"
    ...
    def draw(self, context):
        ...
        rows = 2
        row = layout.row()
        row.template_list("VIEW3D_UL_print3d_items", "", scn, "custom", scn, "custom_index", rows=rows)
...
class VIEW3D_print3d_objectCollection(PropertyGroup):
