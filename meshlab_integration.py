...
class MESH_OT_print3d_process_mesh_in_meshlab(Operator):
    bl_idname = "mesh.print3d_mesh_to_meshlab"
    bl_label = "3D-Print Export a Mesh to Meshlab"
    bl_description = "Trigger the Desired Process"
    bl_options = {'REGISTER', 'UNDO'}

    def execute(self, context):
        self.report({'INFO'}, "SORRY NO MESHLAB ACTION AVAILABLE")
        return {'FINISHED'}
